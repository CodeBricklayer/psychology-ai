    ...
    <div class="articleDetail-container">
        <div class="header-section">
            <div class="header-content">
                <el-image :src="bookUrl" alt="知识文章详情" style="width: 60px; height: 60px;" />
                <h1>知识文章详情</h1>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="diary-card">
                ...
                <div class="tags-content" v-if="articleDetail.tagArray && articleDetail.tagArray.length > 0">
                    ...
                    <div class="tags-list">
                        <el-tag class="tag-item" v-for="tag in articleDetail.tagArray" type="info" effect="light" :key="tag" >{{ tag }}</el-tag>
                    </div>
                </div>
            </div>
        </div>
...
console.log(route.params.id, '文章ID')
