        ...
        <div class="sidebar">
            ...
            <div class="ai-assistant-info">
                <div class="breathing-circle">
                    <el-image :src="robotUrl" style="width: 25px; height: 25px;" alt="AI助手" />
                </div>
                    ...
                    <div class="session-item" v-for="session in sessionList" @click="handleSessionClick(session)"
                        ...
                        <div class="session-info">
                            ...
                            <div class="session-actions">
                                <el-button text type="danger" size="default" @click="handleDeleteSession(session.id)">
                                    <el-icon>
                                        <DeleteFilled />
                                    </el-icon>
                                </el-button>
            ...
            <div class="chat-header">
                <div class="header-left">
                    <div class="chat-avatar">
                        <el-image :src="likeUrl" style="width: 30px; height: 30px;" alt="AI助手" />
                    </div>
                    <div class="chat-info">
                        <h2>宁渡AI助手</h2>
                        <p>您的贴心AI心理健康助手</p>
            ...
            <div class="chat-messages" v-if="messages">
                ...
                <div class="message-item ai-message" v-if="messages.length === 0">
                    <div class="message-avatar">
                        <el-image :src="robotUrl" style="width: 18px; height: 18px;" alt="AI助手" />
                    </div>
                ...
                <!-- 消息列表 -->
                <div class="message-item" v-else v-for="msg in messages" :key="msg.id"
                    :class="msg.senderType === 1 ? 'user-message' : 'ai-message'">
                    <div class="message-avatar">
                        <el-image v-if="msg.senderType === 1" :src="usersUrl" style="width: 18px; height: 18px;"
                            alt="用户" />
                        <el-image v-else :src="robotUrl" style="width: 18px; height: 18px;" alt="AI助手" />
                    </div>
                    <div class="message-content">
                        <div class="message-bubble">
...
const startNewSession = (message) => {
    ...
    // 设置当前会话为新会话
    currentSession.value = sessionParams
...
const startAiResponse = (sessionId, userMessage) => {
    ...
    // 创建AI消息
    const aiMessage = {
        role: `ai_${Date.now()}_${Math.random().toString(36).substring(2, 9)}`,
        senderType: 2,
        content: '',
        createdAt: new Date().toLocaleString()
    }
