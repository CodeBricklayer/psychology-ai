    ...
    <div class="emotionDiary-container">
        <div class="header-section">
            <div class="header-content">
                <el-image :src="likeUrl" alt="情绪日志" style="width: 60px; height: 60px;" />
                <h1>情绪日志</h1>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="diary-card">
                ...
                <div class="section">
                    ...
                    <div class="rate">
                        <el-rate :max="10" v-model="diaryForm.moodScore" :texts="emotionStatus" show-text size="large" />
                    </div>
                </div>
            </div>
            <!-- 主要情绪 -->
            <div class="diary-card">
                ...
                <div class="emotion-grid">
                    <div v-for="emotion in emotionOptions" :key="emotion.name" class="emotion-card"
                        ...
                        <el-image :src="emotion.url" alt="情绪" style="width: 50px; height: 50px;" />
            ...
            <div class="diary-card">
                ...
                <div class="detail-form">
                    <div class="form-group">
                        ...
                        <el-input type="textarea" v-model="diaryForm.emotionTriggers" rows="3" show-word-limit
                            maxlength="1000" placeholder="今天什么事情影响了您的情绪？" />
                    </div>
                    <div class="form-group">
                        <div class="form-label">今日感想</div>
                        <el-input type="textarea" v-model="diaryForm.diaryContent" rows="5" show-word-limit
                            maxlength="2000" placeholder="写下您今天的想法、感受或发生的有趣的事情..." />
                    </div>
                    ...
                    <div class="action-buttons">
                        ...
                        <el-button type="primary" @click="submitDiary">提交记录</el-button>
                    </div>
                </div>
            </div>
        </div>
...
import { submitDiaryData } from '@/api/frontend'
...
const submitDiary = () => {
    ...
    submitDiaryData(diaryForm).then(res => {
